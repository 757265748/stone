...
{	
	...
	//load info
	var div = Q.createDOM("div", {innerHTML: "姝ｅ湪鍔犺浇璧勬簮涓紝璇风◢鍊�...<br>", style:
	{
		id: "loader",
		position: "absolute",
		width: this.width + "px",
		...
		textAlign: "center",
		color: "#fff",
		font: Q.isMobile ?  'bold 16px 榛戜綋' : 'bold 16px 瀹嬩綋',
...
{
	var content = "姝ｅ湪鍔犺浇璧勬簮涓紝璇风◢鍊�...<br>(" + Math.round(e.target.getLoadedSize()/e.target.getTotalSize()*100) + "%)";
